...
import {getList} from '../../../app/fetch/list';
import HeaderComponent from "../../components/HeaderComponent/index";

import LoadMore from "../../../app/components/LoadMore/index";
...
export default class List extends Component{
    ...
    render(){
        return (
            <div>
                <HeaderComponent title="超给力变美" history={this.props.history}/>
                <div className="face">
    ...
    componentDidMount(){  //页码一加载的时候
        this.processData(getList(this.props.cityName,0));//0 代表页码的索引，默认第一页
