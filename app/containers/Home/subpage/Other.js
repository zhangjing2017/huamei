...
import {getOther} from '../../../fetch/home';
...
export default class Other extends Component{
    ...
    componentDidMount(){  //页码一加载的时候
        this.processData(getOther(this.props.cityName,0));//0 代表页码的索引，默认第一页
    ...
    loadMore(){
        this.setState({
            ...
            this.processData(getOther(this.props.cityName,this.state.page));
        })
    }
    //处理成功后的逻辑
    processData(result){
